<template>
    <div>
        ...
        <el-table :data="orderList" border style="width: 100%">
            <el-table-column prop="tname" label="推广者名称" width="150"> </el-table-column>
            <el-table-column prop="order_id" label="订单编号" width="150"> </el-table-column>
            <el-table-column prop="archivename" label="患者名称" width="150"> </el-table-column>
            <el-table-column prop="attend_name" label="护士名称" width="150"> </el-table-column>
            <el-table-column prop="total_fee" label="订单金额" width="150"> </el-table-column>
            <el-table-column prop="commission" label="订单佣金" width="150"> </el-table-column>
            <el-table-column prop="amount" label="实际佣金支付金额" width="150"> </el-table-column>
            ...
            <el-table-column prop="text" label="备注" width="192"> </el-table-column>
